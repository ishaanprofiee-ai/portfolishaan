            ...
            >
              <Tilt3D className="h-full">
                <a
                  ...
                  rel="noreferrer"
                  className="glass-card glass-hover holo-border group relative flex h-full flex-col overflow-hidden"
                >
                  <div className="relative aspect-[16/10] overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 flex items-end p-6" style={{ transform: "translateZ(40px)" }}>
                      <div className="font-display italic text-4xl leading-none text-white/95 drop-shadow-lg">
                        {p.title}
                      </div>
                    </div>
                    <div className="sticker absolute right-4 top-4 text-white/90 backdrop-blur">
                      {p.status}
                    </div>
                  </div>
