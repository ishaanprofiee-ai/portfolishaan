      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
        {items.map((it, i) => (
          ...
          >
            ...
            />
            <DynamicIcon name={it.icon} className="h-6 w-6 text-foreground/90 transition-transform group-hover:-rotate-6 group-hover:scale-110" />
